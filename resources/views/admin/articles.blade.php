...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Gestión de Artículos</title>
                        ...
                        <tbody>
                            @foreach($articles as $article)
                                <tr>
                                    ...
                                    <td>
                                        @if($article->usuari)
                                            <span class="badge bg-info">{{ $article->usuari->Nom_usuari }}</span>
                                        @else
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('articles.delete', $article->ID) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este artículo?')">
