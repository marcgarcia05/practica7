                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center align-middle">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    <img src="{{ asset('images/reset-password.jpg') }}" class="img-fluid">
                                </div>
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 align-items-center order-1 order-lg-2">
                                    <form action="{{ route('password.update') }}" method="post">
                                        ...
                                        <div class="divider d-flex align-items-center my-4">
                                            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Restablecer Contraseña</p>
                                        </div>
                                        ...
                                        <div class="text-center text-lg-start mt-4 pt-2">
                                            <button type="submit" name="resetPassword" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg"
